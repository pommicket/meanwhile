...
/* package Meanwhile-0.0.0 */
#define VERSION_Meanwhile "0.0.0"
#define MIN_VERSION_Meanwhile(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "Meanwhile-0.0.0"

#define CURRENT_PACKAGE_KEY "Meanwhile-0.0.0"
